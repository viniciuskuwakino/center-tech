    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Certifique-se de utilizar uma senha com números e letras maiúsculas para maior segurança.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password_confirmation" value="Confirma Nova Senha" />
